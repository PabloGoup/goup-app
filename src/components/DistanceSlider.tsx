  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-3 my-4">
      <div className="flex items-center gap-2 text-foreground/80 text-sm font-medium">
        <MapPin className="w-4 h-4 text-[#FE8B02]" />
        <span>{label}</span>
      </div>
      ...
      <div className="flex-1 flex items-center gap-3">
        <div className="relative w-full">
          ...
          <div className="h-2 rounded-full bg-white/10 overflow-hidden">
            <div className="h-full bg-[#FE8B02]" style={{ width: `${pct}%`, opacity: 0.7 }} />
          </div>
          ...
          <input
            ...
            className="
              ...
              [&::-webkit-slider-thumb]:border [&::-webkit-slider-thumb]:border-[#FE8B02]/40
              [&::-webkit-slider-thumb]:shadow [&::-webkit-slider-thumb]:transition-transform
              [&::-webkit-slider-thumb]:active:scale-95
              [&::-moz-range-thumb]:h-5 [&::-moz-range-thumb]:w-5
              [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-white
              [&::-moz-range-thumb]:border [&::-moz-range-thumb]:border-[#FE8B02]/40
          ...
          {showTip && (
            ...
            >
              <div className="px-2 py-0.5 rounded-md text-[11px] font-semibold bg-[#FE8B02] text-white shadow">
                {value} {unit}
              </div>
            </div>
          )}
